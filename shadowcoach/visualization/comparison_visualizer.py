...
This module creates detailed visualizations comparing user technique to references:
- Arm angle comparisons
...
Visualization Types:
    1. Arm Angle Plot
        - User vs reference angles
        - Jab detection markers
        - Time-aligned overlay

    2. Speed Analysis
        - Velocity curves
        - Threshold indicators
        - Detected jab regions
...
Technical Notes:
    ...
    - Supports high-DPI output
    - Configurable plot layouts
    - Automatic scaling
"""
import numpy as np
